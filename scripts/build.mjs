...
async function buildCSS() {
  ...
  for (const file of cssFiles) {
    ...
    const result = await postcss([
      ...
      // preserve: true is required — ThemeManager overrides these custom
      // properties at runtime via documentElement.style.setProperty; inlining
      // them at build time would silently break theme switching.
