...
// Identity is the episode, not the stream it came from. Keying on videoId as well
// meant the same episode played from two addons carried two different ids and so
// produced two Continue Watching rows. dedupeAndSort keeps the most recently
// updated entry per key, so pre-existing duplicates collapse onto the latest
// position on the next write.
