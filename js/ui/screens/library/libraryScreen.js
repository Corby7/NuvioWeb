...
function syncIconSvg() {
  return '<svg viewBox="0 0 256 256" class="library-action-icon" aria-hidden="true" focusable="false"><path fill="currentColor" d="M224,48V96a8,8,0,0,1-8,8H168a8,8,0,0,1,0-16h28.69L182.06,73.37a79.56,79.56,0,0,0-56.13-23.43h-.45A79.52,79.52,0,0,0,69.59,72.71,8,8,0,0,1,58.41,61.27a96,96,0,0,1,135,.79L208,76.69V48a8,8,0,0,1,16,0ZM186.41,183.29a80,80,0,0,1-112.47-.66L59.31,168H88a8,8,0,0,0,0-16H40a8,8,0,0,0-8,8v48a8,8,0,0,0,16,0V179.31l14.63,14.63A95.43,95.43,0,0,0,130,222.06h.53a95.36,95.36,0,0,0,67.07-27.33,8,8,0,0,0-11.18-11.44Z"/></svg>';
}

function manageListsIconSvg() {
  return '<svg viewBox="0 0 256 256" class="library-action-icon" aria-hidden="true" focusable="false"><path fill="currentColor" d="M88,64a8,8,0,0,1,8-8H216a8,8,0,0,1,0,16H96A8,8,0,0,1,88,64Zm128,56H96a8,8,0,0,0,0,16H216a8,8,0,0,0,0-16Zm0,64H96a8,8,0,0,0,0,16H216a8,8,0,0,0,0-16ZM56,56H40a8,8,0,0,0,0,16H56a8,8,0,0,0,0-16Zm0,64H40a8,8,0,0,0,0,16H56a8,8,0,0,0,0-16Zm0,64H40a8,8,0,0,0,0,16H56a8,8,0,0,0,0-16Z"/></svg>';
}
...
export const LibraryScreen = {
  ...
  syncRenderedPickerValues(state) {
    ...
    if (syncBtn instanceof HTMLElement) {
      ...
      // innerHTML, not textContent — the button also carries the sync icon
      // svg, which textContent would otherwise wipe out.
      syncBtn.innerHTML = `${syncIconSvg()}${escapeHtml(state.isSyncing ? t("library_syncing_btn", {}, "Syncing") : t("library_sync_btn", {}, "Sync"))}`;
    }
  },
    ...
    return `
      <section class="library-actions-row">
        <button class="library-action-button focusable library-primary${state.showManageDialog ? " background-focused" : ""}"
          ...
          ${manageListsIconSvg()}${escapeHtml(t("library_manage_lists", {}, "Manage Lists"))}
        </button>
        <button class="library-action-button focusable library-primary"
                data-action="refreshLibrary"
                ${state.pendingOperation || state.isSyncing ? "disabled" : ""}>
          ${syncIconSvg()}${escapeHtml(state.isSyncing ? t("library_syncing_btn", {}, "Syncing") : t("library_sync_btn", {}, "Sync"))}
        </button>
      </section>
    `;
  },
